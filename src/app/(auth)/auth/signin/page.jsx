    ...
    <div className="min-h-screen bg-[#050505] text-white flex flex-col items-center justify-center px-4 font-sans selection:bg-emerald-500/30">
      ...
      <div className="w-full max-w-md bg-[#0a0a0a] border border-white/10 rounded-2xl p-8 shadow-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm">Sign in to continue to SpendSense</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-emerald-500 hover:bg-emerald-400 text-black font-bold py-2.5 rounded-lg transition-all hover:scale-[1.02]"
          >
            Sign In
          </button>
        </form>
        ...
        <p className="mt-8 text-center text-sm text-slate-400">
          ...
          <Link href="/auth/signup" className="text-emerald-500 hover:text-emerald-400 font-medium">
            Sign up
          </Link>
        </p>
      </div>
